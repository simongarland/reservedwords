...
ZNAMES:asc distinct`.z.i`.z.d`.z.D`.z.t`.z.T`.z.f`.z.x`.z.a`.z.h`.z.u`.z.w`.z.z`.z.Z`.z.k`.z.l`.z.o`.z.b`.z.s`.z.pg`.z.pi`.z.ps`.z.po`.z.pc`.z.ph`.z.pp`.z.ts`.z.vs`.z.pw`.z.exit`.z.W
